...
def popper(settings):
    ...
    #     if not settings.single_solve:
    #         input_size = (5 + size) * int(settings.max_rules/2)
    #         settings.logger.info(f'SIZE: {input_size} MAX_SIZE: {settings.max_literals}')
    #         generator.update_number_of_literals(input_size)
