...
:-
	...
	max_vars(Mv),
	A = 0..Mv-1,
	#count{B: body_literal(T, left, _, (A, B))} > 1.
...
:-
	...
	max_vars(Mv),
	A = 0..Mv-1,
	#count{B: body_literal(T, right, _, (A, B))} > 1.
...
:-
	...
	max_vars(Mv),
	A = 0..Mv-1,
	#count{B: body_literal(T, value, _, (A, B))} > 1.
...
:-
	...
	max_vars(Mv),
	A = 0..Mv-1,
	#count{B: body_literal(T, min_list, _, (A, B))} > 1.
...
:-
	...
	max_vars(Mv),
	A = 0..Mv-1,
	#count{B: body_literal(T, max_list, _, (A, B))} > 1.

:-
    body_literal(T, ord_union, _, (A1, B1, C1)),
    body_literal(T, ord_union, _, (B1, C1, C2)).

:-
    body_literal(T, ord_union, _, (A1, B1, C1)),
    body_literal(T, ord_union, _, (A2, C1, C2)).

:-
    body_literal(T, ord_union, _, (A1, B1, C1)),
    body_literal(T, ord_union, _, (C1, B1, C2)).

:-
    body_literal(T, ord_union, _, (A1, B1, C1)),
    body_literal(T, ord_union, _, (C1, A1, C2)).


:-
    body_literal(T, ord_union, _, (A1, B1, C1)),
    body_literal(T, ord_union, _, (A2, C1, B1)).

:-
    body_literal(T, ord_union, _, (A1, B1, C1)),
    body_literal(T, ord_union, _, (A2, C1, A1)).

:-
    body_literal(T, ord_union, _, (A1, B1, C1)),
    body_literal(T, ord_union, _, (C1, B2, A1)).
...
:-
    body_literal(T, ord_union, _, (A1, B1, C1)),
    body_literal(T, ord_union, _, (A2, B1, C1)),
	A1 != A2.

:-
    body_literal(T, ord_union, _, (A1, B1, C1)),
    body_literal(T, ord_union, _, (B1, B2, C1)).

:-
    body_literal(T, ord_union, _, (A1, B1, C1)),
    body_literal(T, ord_union, _, (A1, B2, C1)),
	B1 != B2.
...
:-
    ...
    body_literal(T, insert, _, (A1, B1, C2)),
	C1 != C2.

:-
    body_literal(T, insert, _, (A1, B1, C1)),
    body_literal(T, insert, _, (C1, B1, C2)).

:-
	body_literal(T, empty, _, (A1,)),
	body_literal(T, ord_union, _, (A1, B2, C2)).
:-
	body_literal(T, empty, _, (A1,)),
	body_literal(T, ord_union, _, (A2, A1, C2)).

:- 
	body_literal(T, empty, _, (A1,)),
	body_literal(T, gt_list, _, (A2, A1)).

:- 
	body_literal(T, empty, _, (A1,)),
	body_literal(T, lt_list, _, (A2, A1)).

:- 
	body_literal(T, empty, _, (A1,)),
	body_literal(T, min_list, _, (A1, B2)).

:- 
	body_literal(T, empty, _, (A1,)),
	body_literal(T, max_list, _, (A1, B2)).
...
:-
    ...
    body_literal(T, maxnum, _, (B1, C1, C2)).

:-
    body_literal(T, maxnum, _, (A1, B1, C1)),
    body_literal(T, maxnum, _, (A1, C1, C2)).

:-
    body_literal(T, maxnum, _, (A1, B1, C1)),
    body_literal(T, maxnum, _, (C1, B1, C2)).

:-
    body_literal(T, maxnum, _, (A1, B1, C1)),
    body_literal(T, maxnum, _, (C1, A1, C2)).
...
:-
    body_literal(T, maxnum, _, (A1, B1, C1)),
    body_literal(T, maxnum, _, (A2, C1, B1)).

:-
    body_literal(T, maxnum, _, (A1, B1, C1)),
    body_literal(T, maxnum, _, (A2, C1, A1)).

:-
    body_literal(T, maxnum, _, (A1, B1, C1)),
    body_literal(T, maxnum, _, (C1, B2, A1)).


:-
    body_literal(T, maxnum, _, (A1, B1, C1)),
    body_literal(T, maxnum, _, (A2, B1, C1)),
	A1 != A2.

:-
    body_literal(T, maxnum, _, (A1, B1, C1)),
    body_literal(T, maxnum, _, (B1, B2, C1)).

:-
    body_literal(T, maxnum, _, (A1, B1, C1)),
    body_literal(T, maxnum, _, (A1, B2, C1)),
	B1 != B2.
...
:-
	...
	body_literal(T, my_succ, _, (A2, B1)),
	A1 != A2.
...
:-
    ...
    body_literal(T, minnum, _, (B1, C1, C2)).

:-
    body_literal(T, minnum, _, (A1, B1, C1)),
    body_literal(T, minnum, _, (A1, C1, C2)).

:-
    body_literal(T, minnum, _, (A1, B1, C1)),
    body_literal(T, minnum, _, (C1, B1, C2)).

:-
    body_literal(T, minnum, _, (A1, B1, C1)),
    body_literal(T, minnum, _, (C1, A1, C2)).


:-
    body_literal(T, minnum, _, (A1, B1, C1)),
    body_literal(T, minnum, _, (A2, C1, B1)).

:-
    body_literal(T, minnum, _, (A1, B1, C1)),
    body_literal(T, minnum, _, (A2, C1, A1)).

:-
    body_literal(T, minnum, _, (A1, B1, C1)),
    body_literal(T, minnum, _, (C1, B2, A1)).
...
:-
    body_literal(T, minnum, _, (A1, B1, C1)),
    body_literal(T, minnum, _, (A2, B1, C1)),
	A1 != A2.

:-
    body_literal(T, minnum, _, (A1, B1, C1)),
    body_literal(T, minnum, _, (B1, B2, C1)).

:-
    body_literal(T, minnum, _, (A1, B1, C1)),
    body_literal(T, minnum, _, (A1, B2, C1)),
	B1 != B2.
...
:-
	body_literal(T, maxnum, _, (A1, B1, C1)),
    body_literal(T, minnum, _, (B1, A1, C2)).
...
:-
	body_literal(T, minnum, _, (A1, B1, C1)),
    body_literal(T, maxnum, _, (B1, A1, C2)).
