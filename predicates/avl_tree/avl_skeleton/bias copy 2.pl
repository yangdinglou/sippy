...
% p(A):- nullptr(A).
% p(A):- right(A,B),height(B,C),left(A,D),height(A,E),height(D,F),diff_lessthanone(C,F),maxnum(G,C,F),my_prev(E,G),p(D),p(B).
% ******************************
% Num. programs: 4048
% Generate:
%         Called: 4060 times       Total: 9.72     Mean: 0.002     Max: 1.818      Percentage: 25%
% Find Mucs:
%         Called: 234 times        Total: 9.14     Mean: 0.039     Max: 0.465      Percentage: 24%
% Constrain:
%         Called: 4047 times       Total: 8.63     Mean: 0.002     Max: 0.099      Percentage: 22%
% Ground:
%         Called: 4047 times       Total: 6.20     Mean: 0.002     Max: 0.247      Percentage: 16%
% Init:
%         Called: 13 times         Total: 1.93     Mean: 0.148     Max: 1.823      Percentage: 5%
% Test:
%         Called: 4048 times       Total: 1.87     Mean: 0.000     Max: 0.017      Percentage: 4%
% Combine:
%         Called: 3809 times       Total: 0.12     Mean: 0.000     Max: 0.001      Percentage: 0%
% Total operation time: 37.61s
% Total execution time: 43.60s
