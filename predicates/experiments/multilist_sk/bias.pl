...
:-
	not body_literal(0, nullptr, _, (0,)).

:-
	not body_literal(1, child, _, (0, _)).
:-
	body_literal(1, child, _, (0, X)),
	not body_literal(1, inv1, _, (X,_)).

:-
	#count{Vars : body_literal(1,inv1,_,Vars)} != 1.

:-
	not body_literal(1, next, _, (0, _)).
:-
	body_literal(1, next, _, (0, X)),
	not body_literal(1, p, _, (X,_)).

:-
	#count{Vars : body_literal(1,p,_,Vars)} != 1.

:-
	not body_literal(2, nullptr, _, (0,)).

:-
	not body_literal(3, next2, _, (0, _)).
:-
	body_literal(3, next2, _, (0, X)),
	not body_literal(3, inv1, _, (X,_)).

:-
	#count{Vars : body_literal(3,inv1,_,Vars)} != 1.

:-
	#count{Vars : body_literal(3,p,_,Vars)} != 0.
